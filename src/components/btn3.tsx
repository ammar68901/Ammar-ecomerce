...
export default function Btn3 (props:{btnpic:string}) {
    ...
    return (
      <div onClick={handleClick} className="w-[250px] h-[280px] border border-gray-300 rounded-[80px] bg-center bg-cover group mb-4 mt-9" style={{ backgroundImage: `url(${props.btnpic})` }}>
          <div className="flex flex-col gap-[4rem] rounded-[100%]">
            <div className="w-[55px] h-[20px] rounded-full bg-blue-800 items-center mt-[2.25rem] -rotate-45"><p className="text-white font-sans">Sale`s</p></div>
          ...
          <div className="flex justify-around items-center rounded-[10px] h-[24%] bg-gray-300 group-hover:bg-[#2f1ac4] group-hover:text-white">
            <p className="text-[13px]">Comfort Handy Craft</p>
            <p className="text-[13px]">$42 <span className="text-[13px]">$65</span></p>
          </div>
